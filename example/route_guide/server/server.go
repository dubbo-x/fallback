...
import (
	...
	pb "github.com/dubbo-x/fallback/example/route_guide/routeguide"
...
func main() {
	...
	opts = append(opts, grpc.UnknownServiceHandler(rh.Handle))
	grpcServer := grpc.NewServer(opts...)
	go func() {
		time.Sleep(25 * time.Second)
		pb.RegisterRouteGuideServer(rh, newServer())  // register service after server start
